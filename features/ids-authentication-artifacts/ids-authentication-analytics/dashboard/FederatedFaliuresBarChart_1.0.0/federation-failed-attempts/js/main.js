var view = {
    ...
    subscriptions: [{
        ...
        callback: function(topic, data, subscriberData) {
            ...
            client.getFederatedFailedAttempts(filter, function (response) {
...
function urlAppend(filter){
    ...
    $("#downloadpdf").attr("href","/portal/apis/report" + "?type=25&timeFrom=" + filter["timeFrom"]
        + "&timeTo=" + filter["timeTo"] + "&operator=" + filter["operator"]
        + "&appID=" + filter["appID"]+"&download=pdf");
    $("#downloadxl").attr("href","/portal/apis/report" + "?type=25&timeFrom=" + filter["timeFrom"]
        + "&timeTo=" + filter["timeTo"] + "&operator=" + filter["operator"]
