...
(function () {
    ...
    var configure = function () {
        ...
        var initUI = function () {
            ...
            // restore gadget state from global state
            wso2.gadgets.state.getGlobalState('test',function(gadgetState) {
		console.log("get gadget state called");
		...
		wso2.gadgets.state.setGlobalState('test',newState);
            });
        }
