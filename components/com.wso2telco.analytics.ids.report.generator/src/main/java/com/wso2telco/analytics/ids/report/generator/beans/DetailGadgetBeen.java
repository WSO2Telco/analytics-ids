...
public class DetailGadgetBeen {
    ...
    public DetailGadgetBeen(String date, ArrayList arrayList) {
        this.date = date;
        this.row1 = arrayList.get(0).toString();
        this.row2 = arrayList.get(1).toString();
        this.row3 = arrayList.get(2).toString();
        this.row4 = arrayList.get(3).toString();
        this.row5 = arrayList.get(4).toString();
        this.row6 = arrayList.get(5).toString();
        this.row7 = arrayList.get(6).toString();
        this.row8 = arrayList.get(7).toString();
        this.row9 = arrayList.get(8).toString();
        this.row10 = arrayList.get(9).toString();
        this.row11 = arrayList.get(10).toString();
        this.row12 = arrayList.get(11).toString();
        this.row13 = arrayList.get(12).toString();
        this.row14 = arrayList.get(13).toString();
        this.row15 = arrayList.get(14).toString();
        this.row16 = arrayList.get(15).toString();
        this.row17 = arrayList.get(16).toString();
        this.row18 = arrayList.get(17).toString();
        this.row19 = arrayList.get(18).toString();
        this.row20 = arrayList.get(19).toString();
        this.row21 = arrayList.get(20).toString();
