...
public class MsisdnSharingReportGenerationImpl implements MsisdnSharingReportGenerationService {
    private static final Log log = LogFactory.getLog(MsisdnSharingReportGenerationImpl.class);
    String fileName;
    String uuid ;
    String workingDir ;


    public MsisdnSharingReportGenerationImpl(){
        uuid = UUID.randomUUID().toString();
        workingDir = System.getProperty("user.dir");
    }

    @Override
    public void generate(MSISDNSharingReportComponents MSISDNSharingReportComponents) {
        Thread msisdnreport = new MsisdnSharingThreadImpl(MSISDNSharingReportComponents);
        msisdnreport.start();
    }
